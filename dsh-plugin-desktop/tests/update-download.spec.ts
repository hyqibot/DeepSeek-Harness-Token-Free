...
describe('public GitHub Release installer URLs', () => {
  it('points Windows and macOS downloads at versioned public Release assets', () => {
    expect(desktopDownloadUrl('win32', '2.0.1')).toBe(
      'https://github.com/hyqibot/DeepSeek-Harness-Token-Free/releases/download/v2.0.1/DSH-Desktop-2.0.1-x64-Setup.exe',
    )
    expect(desktopDownloadUrl('darwin', '2.0.1', 'arm64')).toBe(
      'https://github.com/hyqibot/DeepSeek-Harness-Token-Free/releases/download/v2.0.1/DSH-Desktop-2.0.1-arm64.dmg',
    )
    expect(desktopDownloadUrl('darwin', '2.0.1', 'x64')).toBe(
      'https://github.com/hyqibot/DeepSeek-Harness-Token-Free/releases/download/v2.0.1/DSH-Desktop-2.0.1-x64.dmg',
    )
    expect(desktopDownloadUrl('win32', '2.0.1')).not.toContain('dshdesktop.cn')
    expect(desktopDownloadUrl('darwin', '2.0.1', 'arm64')).not.toContain('/api/downloads/')
  })
})
