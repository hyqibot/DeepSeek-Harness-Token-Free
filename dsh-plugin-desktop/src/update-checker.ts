/** Headless version checks against the public GitHub Release latest.json. */

/** Public GitHub repository that hosts desktop installers. */
export const PUBLIC_RELEASES_REPO = 'hyqibot/DeepSeek-Harness-Token-Free'

/** Public endpoint returning `{ "version": "x.y.z" }` for the latest stable release. */
export const DESKTOP_VERSION_ENDPOINT =
  `https://github.com/${PUBLIC_RELEASES_REPO}/releases/latest/download/latest.json`
