...
export const REQUIRED_UNPACKED_RUNTIME_ENTRIES = [
  ...
  'lib/directory-picker-browse.js',
...
export const REQUIRED_UNPACKED_PACKAGE_SPECIFIERS = [
  ...
  'dsh-plugin-desktop/channels',
  'dsh-plugin-desktop/mobile',
  'dsh-plugin-desktop/zero-token',
  'dsh-plugin-desktop/marketplace',
  'dsh-plugin-desktop/windows-pwsh-sandbox',
  'dsh-plugin-desktop/directory-picker-browse',
