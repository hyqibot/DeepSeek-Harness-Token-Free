...
外层 README 文件和资源由产品仓库拥有，并保留 `hyqibot/DeepSeek-Harness-Token-Free` 已有的 DSH Desktop 落地页；这些内容不从官方源码子模块派生。package 级初始化和发行文档属于 [`dsh-plugin-desktop/README.md`](../../../../dsh-plugin-desktop/README.md)。
